...
class Cliente(models.Model):
    ...
    genero = models.CharField(
        max_length=15, choices=listaGenero, null=False, default="femenino")
    estadoCivil = models.CharField(
        max_length=15, choices=listaEstadoCivil, null=False, default="soltero")
    correo = models.EmailField(max_length=100, null=False)
    telefono = models.CharField(max_length=15, null=False)
    celular = models.CharField(max_length=15, null=False)
    direccion = models.TextField(
        max_length=75, null=False, default="Direccion")
...
class Cuenta(models.Model):
    ...
    tipoCuenta = models.CharField(
        max_length=30, choices=listaTipoCuenta, default='ahorros', null=False)
...
class Transaccion(models.Model):
    ...
    tipo = models.CharField(
        max_length=30, choices=listaTipoTransacciones, null=False)
    valor = models.DecimalField(max_digits=10, decimal_places=3, null=False)
    descripcion = models.TextField(default='descripcion de la transacción')
